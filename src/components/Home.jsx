...
<div className=" max-w-full  ">
      ...
      <button onClick={() => nav('/home/product')}> <button  className=' duration-700 hover:bg-[#f2c119] hover:text-[#2a2a2c] text-[18px bg-[#1d37fd] p-[10px] sm:p-[14px] w-40 sm:w-44 rounded-full mt-10 text-white'>SHOP NOW</button></button>
